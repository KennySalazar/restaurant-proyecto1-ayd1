...
public interface ComandaRepository extends JpaRepository<Comanda, Long> {
    ...
    @Query("SELECT DISTINCT c FROM Comanda c " +
           ...
           "WHERE c.id = :id AND c.account.restaurantId = :restaurantId")
    Optional<Comanda> findByIdWithDetailsAndRestaurantId(@Param("id") Long id, @Param("restaurantId") Long restaurantId);
