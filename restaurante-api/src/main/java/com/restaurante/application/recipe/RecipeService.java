...
/**
 * Servicio de aplicación para la definición y cálculo de costos de recetas de platillos (HU-008).
 */
@Service
public class RecipeService {
    ...
    /**
     * Define la receta de un platillo con sus insumos y cantidades exactas (HU-008).
     *
    ...
    public RecipeRegistrationResponse defineRecipe(Long dishId,
        ...
        // Escenario: Intentar registrar una receta cuando el platillo ya cuenta con una vigente
        ...
        // Escenario: Intentar definir una receta sin insumos
        ...
        // Validaciones de insumos: cantidades válidas y no duplicados
        ...
        for (RecipeIngredientRequest ingredient : request.ingredients()) {
            ...
            // Escenario: Intentar asociar un insumo con una cantidad menor o igual a cero
            ...
            // Escenario: Intentar agregar un insumo duplicado a la misma receta
        ...
        // 1. Crear versión en estado BORRADOR (requerido por triggers de BD)
        ...
        // 2. Asociar cada insumo con la cantidad indicada (en estado BORRADOR)
        ...
        // 3. Pasar la versión a VIGENTE con su marca de tiempo
    ...
    private RecipeResponse buildRecipeResponse(RecipeVersion version) {
        ...
        for (RecipeDetail detail : version.getDetails()) {
            ...
            // Fórmula oficial: (rd.cantidad * ur.factor_a_base / us.factor_a_base) * i.costo_unitario_actual
